...
@ManageableEntityType("org.splash.WildcardRoute")
public class WildcardRoute extends Route
{
    public static class Factory implements ManageableEntityFactory
    {
        ...
        {
            return new WildcardRoute(id, name, args);
        }
    }
    ...
    public WildcardRoute(String id, String name, Map<String, Object> args) throws IllegalArgumentException
    {
        super(id, name, args);
