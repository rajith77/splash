...
class DefaultConnection extends BaseConnection implements NetworkConnection.ByteReceiver
{
    private NetworkConnection _network;

    private ConnectionSettings _settings;

    DefaultConnection(ConnectionSettings settings, EventHandler ... handlers)
    {
        _settings = settings;
        _handlers = handlers;
    }
